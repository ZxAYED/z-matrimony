      ...
      <section className="bg-[#ff3366] p-6 min-h-screen ">
        <div className="flex justify-center  pt-5 items-center gap-2">
          <img
            ...
            alt=""
          />
          <a className=" -ghost  text-white text-2xl">TaqWaMate</a>
        </div>
        <h1 className="flex justify-center items-center my-4 font-semibold  text-white">
          {" "}
          User :{user.email}
        </h1>
        <div className="flex flex-col text-center   items-left ">
          <h1 className="text-xl font-black my-6 text-white ">
            Dashboard Routes{" "}
          </h1>
          {email?.Role === "admin" ? (
            <div>
              ...
              <div className="">
                <p
                  className="hover:text-white my-4 font-semibold bg-[#33ccff] p-2 rounded-xl 
                        "
                >
                  {" "}
                  <NavLink
                    ...
                    className={({ isActive, isPending }) =>
                      isPending
                        ...
                        : "hover:text-white font-semibold bg-[#33ccff] p-2 rounded-xl "
                    }
                  >
                    {" "}
                    Admin's DashBoard
                ...
                <p
                  className="hover:text-white font-semibold bg-[#33ccff] p-2 rounded-xl  my-4
                        "
                >
                  {" "}
                  <NavLink
                    to="/Dashboard/admin/approve"
                    className={({ isActive, isPending }) =>
                      isPending
                        ? " pending"
                        : isActive
        ...
        <hr
          className='h-2  data-aos="fade-down"
     data-aos-easing="linear"
     data-aos-duration="800"  my-2 w-full  lg:w-[80%] mx-auto font-medium'
        ...
        <div className="flex flex-col  items-left text-center ">
          ...
          <button
            ...
            className="hover:text-white my-2 font-medium bg-[#33ccff] w-full p-2 rounded "
          >
            Log Out
          </button>
        </div>
