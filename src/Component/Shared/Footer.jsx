          ...
          <div className="grid grid-cols-2 ml-10 gap-4 md:col-span-1 lg:col-span-3">
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <a href="/" className="text-gray-600 hover:text-[#ff3366]">
                    Wedding
                  </a>
                </li>
                <li>
          ...
          Events and Meetups
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-4 md:col-span-1 lg:col-span-3">
  <div>
    <p className="font-semibold text-gray-800">Inspiration</p>
    <ul className="mt-2 space-y-2">
      <li>
        <a href="/" className="text-gray-600 hover:text-[#ff3366]">
          Real Love Stories
      ...
      {/* Add more resource topics as needed */}
        ...
        <div className="border-t mt-8 pt-8 flex items-center justify-between">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} TaqwaMate. All rights reserved.
          </p>
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            ...
            <a
              href="/"
              className="text-gray-500 hover:text-[#ff3366] transition-colors duration-300"
            >
