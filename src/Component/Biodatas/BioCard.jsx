...
const BioCard = ({item}) => {
    ...
    return (
        ...
        <div className="flex items-center px-6 py-3 bg-[#4a90e2]">
            ...
            <h1 className="mx-3 text-lg font-semibold text-white">{biodataType}</h1>
        </div>
    
        <div className="px-6 py-4">
            <h1 className="text-xl font-semibold  text-white">Name: {name}</h1>
    
            <p className="py-2  "> Age : {age} years</p>
            ...
            <div className="flex items-center mt-4  ">
                ...
                <h1 className="px-2 text-sm">Profession : {occupation}</h1>
            </div>
            ...
            <div className="flex items-center mt-4  ">
                ...
                <h1 className="px-2 text-sm">Location : {permanentDivision}</h1>
            </div>
            ...
            <div className="flex items-center mt-4  ">
                ...
                <h1 className="px-2 text-sm">Email : {contactEmail}</h1>
            </div>
            <div className="absolute bottom-5 right-[30%] left-[30%] "><Link to={`/singleCard/${_id}`}> <Butoon  heading={"View Profile"}></Butoon></Link></div>
